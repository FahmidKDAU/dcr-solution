...
const renderTaskContent = (
  ...
  switch (task.TaskType) {
    case "Change Authority Approval":
      return (
        <CAApprovalTask task={task} cr={cr} onTaskComplete={onTaskComplete} />
      );

    case "Change Authority Review":
      return (
        <CAReviewTask task={task} cr={cr} onTaskComplete={onTaskComplete} />
      );

    case "Document Change Process":
      return (
        <DocumentChangeProcessTask
          task={task}
          cr={cr}
      ...
      >
        {task.Requestor?.Title && (
          <>
            ...
            <Box>
              <Typography
                sx={{ fontSize: 11, color: "#A19F9D", lineHeight: 1.2 }}
              >
                Requested by
              </Typography>
              <Typography
